...
public class EngineController {
    ...
    public ResponseEntity<byte[]> generate(@RequestBody Map<String, Object> request) {
        ...
        TemplateStateV2 initial = new TemplateStateV2(release.revision(), Collections.<String, com.devagentstudio.template.engine.core.v2.CapabilityState>emptyMap(),
                Collections.<String, com.devagentstudio.template.engine.core.v2.CapabilityState>emptyMap(), Collections.<String, com.devagentstudio.template.engine.core.v2.AppliedAdditionState>emptyMap());
