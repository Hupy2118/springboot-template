...
class LegacyCutoverArchitectureTest {
    ...
    void v1CoreAndLegacySourceLoaderAreAbsent() {
        ...
        for (String relative : Arrays.asList(
                "template-engine/engine-core/src/main/java/com/xcodeagent/template/engine/core/TemplateEngine.java",
                "template-engine/engine-core/src/main/java/com/xcodeagent/template/engine/core/TemplateState.java",
                "template-engine/engine-core/src/main/java/com/xcodeagent/template/engine/core/CorePlanResult.java",
                "template-engine/engine-core/src/main/java/com/xcodeagent/template/engine/core/WorkspaceFixture.java",
                "template-engine/engine-core/src/main/java/com/xcodeagent/template/engine/source/TemplateSourceLoader.java",
